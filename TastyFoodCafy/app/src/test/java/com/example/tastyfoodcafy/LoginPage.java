package com.example.tastyfoodcafy;
...
import mra.com.tastyfoodcafe.AboutUsActivity;
import mra.com.tastyfoodcafe.FeedbackActivity;
import mra.com.tastyfoodcafe.MainDrawerWindowActivity;
...
public class LoginPage extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(user!=null){
            Intent i=new Intent(LoginPage.this, MainDrawerWindowActivity.class);
            startActivity(i);
            finish();
        }
    ...
    private void callingfeedandabout()
    {
        f.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginPage.this, FeedbackActivity.class));
        ...
        a.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginPage.this, AboutUsActivity.class));
                        ...
                        reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful())
                                {
                                    ...
                                    startActivity(new Intent(LoginPage.this, MainDrawerWindowActivity.class));
                                    progressDialog.dismiss();
                                }
                                else
                                {
    ...
    private class AwesomeValidation {
    }

    private class MaskEditText {
